...
var _default = exports.default = {
  ...
  ja: {
    translation: (_translation2 = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation2, StatusCode.ERR_TEMPORARY_UNAVAILABLE, '現在、こちらのサイトはご利用いただけません。'), StatusCode.ERR_UNAVAILABLE, 'こちらの商品の代理購入はできません。'), StatusCode.ERR_EXCLUDED_ITEM, 'こちらの商品はお取扱対象外となります。'), StatusCode.ERR_SELECTION_OPTIONS, 'ページ内のオプション（サイズ、カラー等）をご選択ください。'), StatusCode.ERR_CURRENCY_UNAVAILABLE, 'こちらのサイトの表示通貨は日本円 (JPY) をご選択ください。'), StatusCode.ERR_MULTIPLE_ITEMS, 'ご希望の商品をBuyeeカートへ追加するには、各商品の詳細ページを表示し、Add to Buyeeをご利用ください。'), StatusCode.ERR_DELIVERY_UNAVAILABLE, 'こちらのサイトの配送先は日本(JAPAN)をご選択ください。'), StatusCode.ERR_SELECTION_QTY, '数量を選択してください。'), StatusCode.ERR_UNAVAILABLE_OVER_STOCK, '在庫不足のため、数量を変更してください。'), StatusCode.ERR_UNAVAILABLE_READ_DELAY, 'オプションの読み込みに失敗しました。ページを再読み込みして、商品の選択肢を表示させてから、拡張機能/アドオンを再度使用してBuyeeカートに投入してください。'), _defineProperty(_defineProperty(_translation2, StatusCode.UNAVAILABLE_PRODUCT_URL_PURCHASE_GUIDANCE, 'こちらの商品ページは"Add to Buyee"をご利用できません。Buyeeトップページから「欲しい商品のURLで買う」をご利用ください。'), StatusCode.ERR_DIGITAL_CONTENT, 'デジタルコンテンツのため海外から購入できません。'))
  },
  cht: {
    translation: (_translation3 = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation3, StatusCode.ERR_TEMPORARY_UNAVAILABLE, '本商店目前無法購買。'), StatusCode.ERR_UNAVAILABLE, '我們無法爲您購買該商品。'), StatusCode.ERR_EXCLUDED_ITEM, '此商品無法進行代理購買。'), StatusCode.ERR_SELECTION_OPTIONS, '請在頁面中選擇商品規格(尺寸、顏色等)。'), StatusCode.ERR_CURRENCY_UNAVAILABLE, '網頁中的貨幣請選擇日圓(JPY)。'), StatusCode.ERR_MULTIPLE_ITEMS, '預想將商品加到購物車裡時，請先進入該商品網頁後，再點擊"Add to Buyee"的圖示。'), StatusCode.ERR_DELIVERY_UNAVAILABLE, '請將寄送地址變更為日本(JAPAN)。'), StatusCode.ERR_SELECTION_QTY, '請選擇希望的數量。'), StatusCode.ERR_UNAVAILABLE_OVER_STOCK, '庫存不足，請變更希望購買數量'), StatusCode.ERR_UNAVAILABLE_READ_DELAY, '選項讀取失敗。請重新載入頁面，顯示商品選擇，然後再次使用擴充功能/附加元件將商品加入Buyee購物車。'), _defineProperty(_defineProperty(_translation3, StatusCode.UNAVAILABLE_PRODUCT_URL_PURCHASE_GUIDANCE, '無法使用"Add to Buyee"的商品頁面。敬請通過Buyee首頁【利用網址申請購買】進行購買。'), StatusCode.ERR_DIGITAL_CONTENT, '數位商品不提供海外購買。'))
  },
  chs: {
    translation: (_translation4 = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation4, StatusCode.ERR_TEMPORARY_UNAVAILABLE, '现在此店铺无法利用。'), StatusCode.ERR_UNAVAILABLE, '我们无法为您购买该商品。'), StatusCode.ERR_EXCLUDED_ITEM, '此商品无法进行代理购买。'), StatusCode.ERR_SELECTION_OPTIONS, '请在页面中选择商品规格(尺寸，颜色等)。'), StatusCode.ERR_CURRENCY_UNAVAILABLE, '网页上的货币请选择日元(JPY)。'), StatusCode.ERR_MULTIPLE_ITEMS, '如果您想将商品添加到Buyee购物车里，请先进入各商品的详细页面，再点击"Add to Buyee"图标。'), StatusCode.ERR_DELIVERY_UNAVAILABLE, '邮寄地址的国家请选择日本(JAPAN)。'), StatusCode.ERR_SELECTION_QTY, '请选择希望的数量。'), StatusCode.ERR_UNAVAILABLE_OVER_STOCK, '库存不足、请变更希望购买数量'), StatusCode.ERR_UNAVAILABLE_READ_DELAY, '选项载入失败。请重新载入页面，显示商品选择，然后再次使用扩展程序/附加元件将商品加入Buyee购物车。'), _defineProperty(_defineProperty(_translation4, StatusCode.UNAVAILABLE_PRODUCT_URL_PURCHASE_GUIDANCE, '无法使用"Add to Buyee"的商品页面。敬请通过Buyee首页【利用网址申请购买】进行购买。'), StatusCode.ERR_DIGITAL_CONTENT, '虚拟商品不提供海外购买。'))
  },
  ko: {
    translation: (_translation5 = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation5, StatusCode.ERR_TEMPORARY_UNAVAILABLE, '상점을 현재 이용할 수 없습니다.'), StatusCode.ERR_UNAVAILABLE, '상품을 주문 처리할 수 없습니다.'), StatusCode.ERR_EXCLUDED_ITEM, '상품은 서비스를 이용할 수 없습니다.'), StatusCode.ERR_SELECTION_OPTIONS, '계속하려면 페이지에서 옵션(크기, 색상 등)을 선택해주세요.'), StatusCode.ERR_CURRENCY_UNAVAILABLE, '페이지에서 통화를 JPY(일본 엔)로 선택해주세요.'), StatusCode.ERR_MULTIPLE_ITEMS, 'Buyee 장바구니에 각각 원하는 상품을 추가하려면 상품 페이지를 방문하여 "Buyee에 추가" 아이콘을 클릭합니다.'), StatusCode.ERR_DELIVERY_UNAVAILABLE, '배송 목적지 국가로 일본을 선택해주세요.'), StatusCode.ERR_SELECTION_QTY, '원하는 수량을 선택해주세요.'), StatusCode.ERR_UNAVAILABLE_OVER_STOCK, '재고 부족으로 수량을 변경해주세요.'), StatusCode.ERR_UNAVAILABLE_READ_DELAY, '옵션 불러오기에 실패했습니다. 페이지를 다시 로드하여 상품 옵션을 표시한 후, 확장 프로그램/애드온을 다시 사용하여 Buyee 카트에 넣으세요.'), _defineProperty(_defineProperty(_translation5, StatusCode.UNAVAILABLE_PRODUCT_URL_PURCHASE_GUIDANCE, '이 상품 페이지는 "Add to Buyee"를 사용할 수 없으며, Buyee 홈페이지에서 "원하는 상품 URL로 구입" 를 이용하시기 바랍니다.'), StatusCode.ERR_DIGITAL_CONTENT, '디지털 컨텐츠이기때문에 해외에서 구입할 수 없습니다.'))
  },
  id: {
  ...
  ms: {
    translation: (_translation7 = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation7, StatusCode.ERR_TEMPORARY_UNAVAILABLE, 'Gedung tidak tersedia pada masa ini.'), StatusCode.ERR_UNAVAILABLE, 'Kami tidak dapat memproses pesanan anda untuk item ini.'), StatusCode.ERR_EXCLUDED_ITEM, 'Item tidak tersedia untuk perkhidmatan.'), StatusCode.ERR_SELECTION_OPTIONS, 'Sila buat pilihan (saiz, warna, dll) pada halaman untuk meneruskan.'), StatusCode.ERR_CURRENCY_UNAVAILABLE, 'Sila pilih Yen Jepun (JPY) sebagai mata wang pada halaman.'), StatusCode.ERR_MULTIPLE_ITEMS, 'Untuk menambah setiap item yang diingini pada troli Buyee, sila lawati halaman item tersebut dan klik ikon "Add to Buyee".'), StatusCode.ERR_DELIVERY_UNAVAILABLE, 'Sila pilih Jepun sebagai negara destinasi penghantaran.'), StatusCode.ERR_SELECTION_QTY, 'Sila pilih kuantiti yang diingini.'), StatusCode.ERR_UNAVAILABLE_OVER_STOCK, 'Insufficient stock. Please change the quantity.'), StatusCode.ERR_UNAVAILABLE_READ_DELAY, '"Variasi tersebut tidak dapat dimuatkan. Silakan memuat semula halaman, paparkan variasi produk dan tambahkan item ke dalam troli Buyee menggunakan fungsi extension/add on."'), _defineProperty(_defineProperty(_translation7, StatusCode.UNAVAILABLE_PRODUCT_URL_PURCHASE_GUIDANCE, '"Add to Buyee" tidak tersedia untuk halaman item ini. Sila gunakan【Beli item yang dikehendaki dengan URL】yang terdapat pada halaman utama Buyee.'), StatusCode.ERR_DIGITAL_CONTENT, 'Item digital tidak dapat dibeli dari luar negara.'))
  },
  vi: {
    translation: (_translation8 = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation8, StatusCode.ERR_TEMPORARY_UNAVAILABLE, 'Hiện tại, không thể truy cập trang web này.'), StatusCode.ERR_UNAVAILABLE, 'Sản phẩm này không thể mua hộ.'), StatusCode.ERR_EXCLUDED_ITEM, 'Sản phẩm này không thể sử dụng dịch vụ.'), StatusCode.ERR_SELECTION_OPTIONS, 'Hãy điền thông tin Kích cỡ, màu sắc... trên trang của sản phẩm.'), StatusCode.ERR_CURRENCY_UNAVAILABLE, 'Hãy chọn đơn vị tiền tệ hiển thị là đồng Yên (JPY) cho trang web này.'), StatusCode.ERR_MULTIPLE_ITEMS, 'Khi bạn muốn thêm vào giỏ hàng của Buyee, hãy truy cập trang của sản phẩm đó và sử dụng công cụ "Add to Buyee".'), StatusCode.ERR_DELIVERY_UNAVAILABLE, 'Ở trang này, hãy chọn nơi giao hàng là Nhật Bản (JAPAN).'), StatusCode.ERR_SELECTION_QTY, 'Hãy chọn số lượng.'), StatusCode.ERR_UNAVAILABLE_OVER_STOCK, 'Vì thiếu hàng nên bạn hãy thay đổi số lượng.'), StatusCode.ERR_UNAVAILABLE_READ_DELAY, 'Đã xảy ra lỗi. Bạn hãy thử tải lại trang. Sau khi các lựa chọn sản phẩm được hiển thị, bạn hãy sử dụng lại extension hoặc add-on để thêm vào giỏ hàng Buyee.'), _defineProperty(_defineProperty(_translation8, StatusCode.UNAVAILABLE_PRODUCT_URL_PURCHASE_GUIDANCE, 'Trang này không thể sử dụng công cụ Add to Buyee. Bạn hãy thực hiện yêu cầu mua hàng tại phần "Mua qua link sản phẩm" ở trang chủ Buyee.'), StatusCode.ERR_DIGITAL_CONTENT, 'Không thể mua nội dung kỹ thuật số từ nước ngoài.'))
  },
  th: {
    translation: (_translation9 = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation9, StatusCode.ERR_TEMPORARY_UNAVAILABLE, 'ร้านค้านี้ยังไม่พร้อมใช้งานในขณะนี้'), StatusCode.ERR_UNAVAILABLE, 'เราไม่สามารถประมวลผลคำสั่งซื้อของคุณสำหรับสินค้านี้ได้'), StatusCode.ERR_EXCLUDED_ITEM, 'สินค้าไม่พร้อมให้บริการ'), StatusCode.ERR_SELECTION_OPTIONS, 'โปรดเลือกตัวเลือกที่ต้องการ(ขนาด, สี, อื่น ๆ ) ในหน้าเว็บเพื่อดำเนินการต่อ'), StatusCode.ERR_CURRENCY_UNAVAILABLE, 'โปรดเลือกสกุลเงินเยน (JPY) เป็นสกุลเงินในหน้าเว็บ'), StatusCode.ERR_MULTIPLE_ITEMS, 'หากต้องการเพิ่มสินค้าที่ต้องการลงในรถเข็น Buyee โปรดไปที่หน้าของสินค้าแล้วคลิกที่ไอคอน "เพิ่มไปยัง Buyee”'), StatusCode.ERR_DELIVERY_UNAVAILABLE, 'โปรดเลือกประเทศญี่ปุ่นเป็นประเทศปลายทางสำหรับการจัดส่ง'), StatusCode.ERR_SELECTION_QTY, 'โปรดเลือกจำนวนสินค้าที่ต้องการ'), StatusCode.ERR_UNAVAILABLE_OVER_STOCK, 'เนื่องจากสินค้าขาดสต็อก กรุณาเปลี่ยนจำนวนสินค้าทีต้องการ'), StatusCode.ERR_UNAVAILABLE_READ_DELAY, 'ไม่สามารถโหลดตัวเลือสินค้าได้ ! กรุณารีโหลดอีกครั้งเพื่อดูตัวเลือกสินค้า จากนั้นลองใช้ extension/add-on เพื่อเพิ่มรายการสินค้าลงในรถเข็น Buyee อีกครั้ง'), _defineProperty(_defineProperty(_translation9, StatusCode.UNAVAILABLE_PRODUCT_URL_PURCHASE_GUIDANCE, 'ไม่สามารถใช้ "Add to Buyee" บนหน้าสินค้านี้ได้ กรุณาใช้「แบบฟอร์มขอซื้อ」จากหน้าบนสุดของ Buyee'), StatusCode.ERR_DIGITAL_CONTENT, 'เนื่องจากเป็นเนื้อหาดิจิทัลจึงไม่สามารถซื้อจากต่างประเทศได้'))
  },
  my: {
    translation: (_translation0 = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation0, StatusCode.ERR_TEMPORARY_UNAVAILABLE, 'ဤဆိုက်သည် လောလောဆယ် မရရှိနိုင်ပါ။'), StatusCode.ERR_UNAVAILABLE, 'ဤပစ္စည်းအတွက် သင့်မှာယူမှုကို ကျွန်ုပ်တို့ မလုပ်ဆောင်နိုင်ပါ။'), StatusCode.ERR_EXCLUDED_ITEM, 'ဤပစ္စည်းကို ကျွန်ုပ်တို့၏ဝန်ဆောင်မှုမှ မပံ့ပိုးနိုင်ပါ။'), StatusCode.ERR_SELECTION_OPTIONS, 'ကျေးဇူးပြု၍ စာမျက်နှာရှိ ရွေးချယ်စရာများ (အရွယ်အစား၊ အရောင်၊ စသည်) ကို ရွေးပါ။'), StatusCode.ERR_CURRENCY_UNAVAILABLE, 'ဤဆိုက်တွင်ပြသထားသောငွေကြေးအဖြစ် ဂျပန်ယန်း (JPY) ကိုရွေးချယ်ပါ။'), StatusCode.ERR_MULTIPLE_ITEMS, 'လိုချင်သောကုန်ပစ္စည်းကို Buyeeဈေးဝယ်ခြင်းသို့ထည့်ရန်၊ ပစ္စည်းတစ်ခုစီ၏အသေးစိတ်စာမျက်နှာကိုပြသပြီး Add to Buyee ကိုအသုံးပြုပါ။'), StatusCode.ERR_DELIVERY_UNAVAILABLE, 'ဤဆိုက်ရှိ ပို့ဆောင်ရေးလိပ်စာအဖြစ် ဂျပန်နိုင်ငံကို ရွေးချယ်ပါ။'), StatusCode.ERR_SELECTION_QTY, 'ကျေးဇူးပြု၍ အရေအတွက်ကို ရွေးချယ်ပါ။'), StatusCode.ERR_UNAVAILABLE_OVER_STOCK, 'Stock မရှိတာကြောင့် အရေအတွက်ကို ပြောင်းပေးပါ။'), StatusCode.ERR_UNAVAILABLE_READ_DELAY, 'ဗားရှင်းကို တင်၍မရပါ။ ကုန်ပစ္စည်းအမျိုးကွဲများကိုကြည့်ရန် စာမျက်နှာကို ပြန်လည်စတင်ပါ၊ ထို့နောက် သင်၏ Buyee တွန်းလှည်းသို့ ထည့်ရန် တိုးချဲ့/အပိုပရိုဂရမ်ကို ထပ်မံအသုံးပြုပါ။'), _defineProperty(_defineProperty(_translation0, StatusCode.UNAVAILABLE_PRODUCT_URL_PURCHASE_GUIDANCE, '"ဝယ်သူသို့ ထည့်ရန်" ဤထုတ်ကုန်စာမျက်နှာတွင် အသုံးမပြုနိုင်ပါ။ ကျေးဇူးပြု၍ Buyee အပေါ်ဆုံးစာမျက်နှာမှ 「လိုချင်သော ကုန်ပစ္စည်း၏ URL ဖြင့် ဝယ်ယူမည်။」ကိုသုံးပါ။'), StatusCode.ERR_DIGITAL_CONTENT, '၎င်းသည် ဒစ်ဂျစ်တယ်အကြောင်းအရာဖြစ်သောကြောင့် နိုင်ငံခြားမှ ဝယ်ယူ၍မရပါ။'))
  },
  es: {
    translation: (_translation1 = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation1, StatusCode.ERR_TEMPORARY_UNAVAILABLE, 'La tienda no está disponible en este momento.'), StatusCode.ERR_UNAVAILABLE, 'No podemos procesar tu pedido de este artículo.'), StatusCode.ERR_EXCLUDED_ITEM, 'El artículo no está disponible para el servicio.'), StatusCode.ERR_SELECTION_OPTIONS, 'Por favor, selecciona las opciones (tamaño, color, etc.) en la página para continuar.'), StatusCode.ERR_CURRENCY_UNAVAILABLE, 'Por favor, elige  yen japonés (JPY) como moneda en la página.'), StatusCode.ERR_MULTIPLE_ITEMS, 'Para añadir cada artículo deseado al carrito de compras de Buyee, visita la página del artículo y haz clic en el icono "Añadir a Buyee".'), StatusCode.ERR_DELIVERY_UNAVAILABLE, 'Por favor, selecciona Japón como país de destino de la entrega.'), StatusCode.ERR_SELECTION_QTY, 'Por favor, elige la cantidad deseada.'), StatusCode.ERR_UNAVAILABLE_OVER_STOCK, 'Existencias insuficientes. Por favor, cambie la cantidad.'), StatusCode.ERR_UNAVAILABLE_READ_DELAY, 'No se han podido cargar las opciones. Vuelva a cargar la página para ver las opciones del artículo, y luego vuelva a utilizar la extensión/add-on para agregar el artículo al carrito de Buyee.'), _defineProperty(_defineProperty(_translation1, StatusCode.UNAVAILABLE_PRODUCT_URL_PURCHASE_GUIDANCE, 'La extensión [Add to Buyee] no está disponible en esta página web. Por favor, utilice nuestro servicio de [Comprar a través de un URL] en la página principal de Buyee.'), StatusCode.ERR_DIGITAL_CONTENT, 'Los contenidos digitales no pueden comprarse desde el extranjero.'))
  },
  fr: {
    translation: (_translation10 = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation10, StatusCode.ERR_TEMPORARY_UNAVAILABLE, 'La boutique n\'est pas disponible actuellement.'), StatusCode.ERR_UNAVAILABLE, 'Nous ne pouvons pas traiter votre commande pour cet article.'), StatusCode.ERR_EXCLUDED_ITEM, 'L\'article n\'est pas pris en charge par notre service.'), StatusCode.ERR_SELECTION_OPTIONS, 'Veuillez sélectionner les options (taille, couleur, etc.) sur la page pour continuer.'), StatusCode.ERR_CURRENCY_UNAVAILABLE, 'Veuillez choisir le yen japonais (JPY) comme devise affichée sur ce site.'), StatusCode.ERR_MULTIPLE_ITEMS, 'Pour ajouter les articles souhaités au panier Buyee, veuillez consulter la page de l\'article et cliquer sur l’icône « Add to Buyee ».'), StatusCode.ERR_DELIVERY_UNAVAILABLE, 'Veuillez sélectionner Japon comme pays de livraison.'), StatusCode.ERR_SELECTION_QTY, 'Veuillez choisir la quantité voulue.'), StatusCode.ERR_UNAVAILABLE_OVER_STOCK, 'Stock insuffisant. Veuillez modifier la quantité.'), StatusCode.ERR_UNAVAILABLE_READ_DELAY, 'Erreur de chargement des variantes du produit. Veuillez actualiser la page, patienter jusqu\'à ce que les variantes du produit s\'affichent correctement, puis ajouter à nouveau le produit de votre choix au panier Buyee en utilisant l\'extension/l\'add-on.'), _defineProperty(_defineProperty(_translation10, StatusCode.UNAVAILABLE_PRODUCT_URL_PURCHASE_GUIDANCE, 'L\'extension « Add to Buyee » n\'est pas compatible avec ce site. Utilisez plutôt le service de « Formulaire de demande d\'achat » disponible sur Buyee.'), StatusCode.ERR_DIGITAL_CONTENT, 'Les produits numériques ne peuvent pas être achetés depuis l\'étranger.'))
  },
  pt: {
    translation: (_translation11 = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation11, StatusCode.ERR_TEMPORARY_UNAVAILABLE, 'A loja não está disponível no momento.'), StatusCode.ERR_UNAVAILABLE, 'Não podemos processar seu pedido para este item.'), StatusCode.ERR_EXCLUDED_ITEM, 'O item não está disponível para o serviço.'), StatusCode.ERR_SELECTION_OPTIONS, 'Por favor, selecione as opções (tamanho, cor, etc) na página para prosseguir.'), StatusCode.ERR_CURRENCY_UNAVAILABLE, 'Por favor, escolha o iene japonês (JPY) como moeda na página.'), StatusCode.ERR_MULTIPLE_ITEMS, 'Para adicionar cada item desejado ao carrinho da Buyee, visite a página do item e clique no ícone "Add to Buyee".'), StatusCode.ERR_DELIVERY_UNAVAILABLE, 'Selecione o Japão como o país de destino da entrega.'), StatusCode.ERR_SELECTION_QTY, 'Escolha a quantidade desejada.'), StatusCode.ERR_UNAVAILABLE_OVER_STOCK, 'Fora de estoque. Por favor altere a quantidade.'), StatusCode.ERR_UNAVAILABLE_READ_DELAY, 'Falha ao carregar as opções. Recarregue a página para apresentar as opções do produto, em seguida, use novamente a extensão/add-on para adicionar itens ao carrinho da Buyee.'), _defineProperty(_defineProperty(_translation11, StatusCode.UNAVAILABLE_PRODUCT_URL_PURCHASE_GUIDANCE, 'A ferramenta [Add to Buyee] não está disponível para este site. Por favor, utilize nosso outro método de compras [Formulário de solicitação de compra] pelo nosso site oficial.'), StatusCode.ERR_DIGITAL_CONTENT, 'Não é possível comprar conteúdos digitais do exterior.'))
  },
  de: {
    translation: (_translation12 = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation12, StatusCode.ERR_TEMPORARY_UNAVAILABLE, 'Der Store ist zurzeit nicht verfügbar.'), StatusCode.ERR_UNAVAILABLE, 'Wir können Ihre Bestellung für diesen Artikel nicht bearbeiten.'), StatusCode.ERR_EXCLUDED_ITEM, 'Der Artikel ist für den Service nicht verfügbar.'), StatusCode.ERR_SELECTION_OPTIONS, 'Bitte wählen Sie die Optionen (Größe, Farbe usw.) auf der Seite aus, um fortzufahren.'), StatusCode.ERR_CURRENCY_UNAVAILABLE, 'Bitte wählen Sie auf der Seite den Japanischen Yen (JPY) als Währung aus.'), StatusCode.ERR_MULTIPLE_ITEMS, 'Um den gewünschten Artikel zum Buyee-Warenkorb hinzuzufügen, besuchen Sie bitte die Seite des Artikels und klicken Sie auf das "Zu Buyee hinzufügen"-Symbol.'), StatusCode.ERR_DELIVERY_UNAVAILABLE, 'Bitte wählen Sie Japan als Lieferzielland aus.'), StatusCode.ERR_SELECTION_QTY, 'Bitte wählen Sie die gewünschte Anzahl.'), StatusCode.ERR_UNAVAILABLE_OVER_STOCK, 'Unzureichender Lagerbestand. Bitte ändern Sie die gewünschte Anzahl.'), StatusCode.ERR_UNAVAILABLE_READ_DELAY, 'Die Optionen konnten nicht geladen werden. Bitte aktualisieren Sie die Seite und warten Sie, bis die Optionen für diesen Artikel angezeigt werden. Anschließend verwenden Sie die Erweiterung/Add-On erneut, um den gewünschten Artikel in den Buyee-Warenkorb zu legen.'), _defineProperty(_defineProperty(_translation12, StatusCode.UNAVAILABLE_PRODUCT_URL_PURCHASE_GUIDANCE, 'Diese Produktseite unterstützt die Verwendung von "Add to Buyee" nicht. Bitte verwenden Sie "Einkaufen mit der URL des gewünschten Artikels" auf der Buyee-Startseite.'), StatusCode.ERR_DIGITAL_CONTENT, 'Der Kauf von digitalen Inhalten aus dem Ausland ist nicht möglich.'))
  },
  it: {
    translation: (_translation13 = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation13, StatusCode.ERR_TEMPORARY_UNAVAILABLE, 'Attualmente non il sito non è utilizzabile'), StatusCode.ERR_UNAVAILABLE, 'Non possiamo processare il suo ordine per questi articoli.'), StatusCode.ERR_EXCLUDED_ITEM, 'Il prodotto non è disponibile per il servizio.'), StatusCode.ERR_SELECTION_OPTIONS, 'Per favore, seleziona le opzioni (taglia, colore, etc) sulla pagina per proseguire.'), StatusCode.ERR_CURRENCY_UNAVAILABLE, 'Per favore, seleziona yen giapponese (JPY) come valuta su questa pagina.'), StatusCode.ERR_MULTIPLE_ITEMS, 'Per aggiungere gli articoli desiderati sul carrello di Buyee, per favore visita la pagina dell\'articolo e clicca sull\'icona "Add to Buyee".'), StatusCode.ERR_DELIVERY_UNAVAILABLE, 'Seleziona il Giappone come paese di destinazione della consegna.'), StatusCode.ERR_SELECTION_QTY, 'Si prega di scegliere la quantità desiderata.'), StatusCode.ERR_UNAVAILABLE_OVER_STOCK, 'Si prega di modificare la quantità a causa di scorte insufficienti.'), StatusCode.ERR_UNAVAILABLE_READ_DELAY, 'Impossibile caricare le opzioni. Ricaricare la pagina per visualizzare le opzioni del prodotto, quindi utilizzare nuovamente l\'estensione/il componente aggiuntivo per aggiungere gli articoli al carrello di Buyee.'), _defineProperty(_defineProperty(_translation13, StatusCode.UNAVAILABLE_PRODUCT_URL_PURCHASE_GUIDANCE, 'Lo strumento [Add to Buyee] non è disponibile per questo sito. Utilizzare "Acquista tramite il link del prodotto che desideri" dalla pagina principale di Buyee.'), StatusCode.ERR_DIGITAL_CONTENT, 'I contenuti digitali non possono essere acquistati all\'estero.'))
  },
  pl: {
    translation: (_translation14 = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation14, StatusCode.ERR_TEMPORARY_UNAVAILABLE, 'Sklep jest w tej chwili nie dostępny.'), StatusCode.ERR_UNAVAILABLE, 'Nie jesteśmy w stanie przetworzyć zamówienia na ten przedmiot.'), StatusCode.ERR_EXCLUDED_ITEM, 'Przedmiot nie jest dostępny dla usługi.'), StatusCode.ERR_SELECTION_OPTIONS, 'Wybierz opcje (rozmiar, kolor etc.), na stronie aby kontynuowć.'), StatusCode.ERR_CURRENCY_UNAVAILABLE, 'Wybierz JPY (japońską walutę) na stronie jako walutę.'), StatusCode.ERR_MULTIPLE_ITEMS, 'Aby dodać pożądany przedmiot do koszyka Buyee, przejdź na stronę przedmiotu i kliknij ikonkę "Add to Buyee".'), StatusCode.ERR_DELIVERY_UNAVAILABLE, 'Wybierz Japonię jako kraj dostawy.'), StatusCode.ERR_SELECTION_QTY, 'Wybierz pożądaną ilość.'), StatusCode.ERR_UNAVAILABLE_OVER_STOCK, 'Niewystarczający zapas. Proszę zmienić ilość.'), StatusCode.ERR_UNAVAILABLE_READ_DELAY, 'Nie udało się wczytać wariantów! Odśwież stronę, wyświetl warianty produktów, a następnie spróbuj ponownie użyć rozszerzenia/dodatku, aby dodać pozycje do koszyka Buyee.'), _defineProperty(_defineProperty(_translation14, StatusCode.UNAVAILABLE_PRODUCT_URL_PURCHASE_GUIDANCE, 'Na stronie tego produktu nie można użyć rozszerzenia [Add to Buyee]. Skorzystaj z opcji „Formularz zamówienia dla innych stron” na stronie głównej Buyee.'), StatusCode.ERR_DIGITAL_CONTENT, 'Zakup treści cyfrowych nie jest dostępny w sprzedaży zagranicznej.'))
  },
  tr: {
    translation: (_translation15 = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation15, StatusCode.ERR_TEMPORARY_UNAVAILABLE, 'Bu mağaza şu an uygun değildir. '), StatusCode.ERR_UNAVAILABLE, 'Bu siparişiniz için işleme devam edemiyoruz.'), StatusCode.ERR_EXCLUDED_ITEM, 'Bu ürün kapsam dışıdır.'), StatusCode.ERR_SELECTION_OPTIONS, 'Devam edebilmek için lütfen opsiyonları (ürün adedi, renk, vs...) seçin. '), StatusCode.ERR_CURRENCY_UNAVAILABLE, 'Lütfen para birimi olarak Japon Yeni (JPY) seçin. '), StatusCode.ERR_MULTIPLE_ITEMS, 'Buyee kartınıza ürün ekleyebilmek için lütfen ürün sayfasından "Add to Buyee" simgesine tıklayın. '), StatusCode.ERR_DELIVERY_UNAVAILABLE, 'Lütfen varış ülkesi olarak Japonya\'yı seçin.'), StatusCode.ERR_SELECTION_QTY, 'Lütfen arzu ettiğiniz ürün adedini girin. '), StatusCode.ERR_UNAVAILABLE_OVER_STOCK, 'Yetersiz stok! Lütfen girdiğiniz miktarı güncelleyin.'), StatusCode.ERR_UNAVAILABLE_READ_DELAY, 'Ürün varyasyonları yüklenemedi! Lütfen sayfayı yeniden yükleyin, ürün çeşitlerini görüntüleyin ve ardından eklentiyi kullanarak ürünü Buyee sepetine ekleyin.'), _defineProperty(_defineProperty(_translation15, StatusCode.UNAVAILABLE_PRODUCT_URL_PURCHASE_GUIDANCE, 'Bu ürün sayfasında "Add to Buyee" kullanılamıyor. Lütfen Buyee ana sayfasından "Diğer Sitelerden Satın Alma Formu" seçeneğini kullanın.'), StatusCode.ERR_DIGITAL_CONTENT, 'Dijital içerikler denizaşırı ülkelerden satın alınamaz.'))
  },
  ru: {
    translation: (_translation16 = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation16, StatusCode.ERR_TEMPORARY_UNAVAILABLE, 'В настоящее время магазин недоступен.'), StatusCode.ERR_UNAVAILABLE, 'Невозможно обработать ваш заказ на этот товар.'), StatusCode.ERR_EXCLUDED_ITEM, 'Товар не доступен для услуги.'), StatusCode.ERR_SELECTION_OPTIONS, 'Выберите дополнительные параметры (размер, цвет и т. д.) на странице, чтобы продолжить.'), StatusCode.ERR_CURRENCY_UNAVAILABLE, 'Выберите на странице японскую иену (JPY) в качестве валюты.'), StatusCode.ERR_MULTIPLE_ITEMS, 'Чтобы добавить каждый нужный товар в корзину Buyee, перейдите на страницу товара и щелкните значок «Добавить в Buyee».'), StatusCode.ERR_DELIVERY_UNAVAILABLE, 'Выберите Японию в качестве страны доставки.'), StatusCode.ERR_SELECTION_QTY, 'Выберите нужное количество.'), StatusCode.ERR_UNAVAILABLE_OVER_STOCK, 'Недостаточно товара на складе. Пожалуйста, измените запрашиваемое количество.'), StatusCode.ERR_UNAVAILABLE_READ_DELAY, 'Не удалось загрузить нужную опцию. Для просмотра доступных вариантов, пожалуйста, перезагрузите страницу, а затем снова используйте расширение/add-on, чтобы добавить товар в корзину для покупок.'), _defineProperty(_defineProperty(_translation16, StatusCode.UNAVAILABLE_PRODUCT_URL_PURCHASE_GUIDANCE, 'Эта страница не поддерживает функцию "Add to Buyee". Пожалуйста, воспользуйтесь "Покупка по URL товара" на главной странице Buyee.'), StatusCode.ERR_DIGITAL_CONTENT, 'Цифровой контент недоступен для покупки из-за рубежа.'))
  },
  ar: {
    translation: (_translation17 = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation17, StatusCode.ERR_TEMPORARY_UNAVAILABLE, 'الموقع غير متوفر حاليا.'), StatusCode.ERR_UNAVAILABLE, 'الموقع غير متوفر حاليا.'), StatusCode.ERR_EXCLUDED_ITEM, 'المنتج غير متوفر للخدمة.'), StatusCode.ERR_SELECTION_OPTIONS, 'يرجى تحديد الخيارات (الحجم واللون وغيره) في الصفحة .'), StatusCode.ERR_CURRENCY_UNAVAILABLE, 'يرجى اختيار الين الياباني (JPY) كعملة العرض لهذا الموقع.'), StatusCode.ERR_MULTIPLE_ITEMS, 'لإضافة منتج ترغب فيه إلى عربة تسوق Buyee، افتح صفحة تفاصيل المنتج واستخدم "Add to Buyee".'), StatusCode.ERR_DELIVERY_UNAVAILABLE, 'الرجاء اختيار اليابان (JAPAN) كبلد الشحن لهذا الموقع'), StatusCode.ERR_SELECTION_QTY, 'يرجى اختيار الكمية المطلوبة.'), StatusCode.ERR_UNAVAILABLE_OVER_STOCK, 'نظرًا لنقص المخزون، يرجى تغيير الكمية.'), StatusCode.ERR_UNAVAILABLE_READ_DELAY, 'تعذر تحميل الخيار. يرجى تحديث الصفحة، وعرض خيارات المنتج، ثم محاولة استخدام الإضافة/الملحق مرة أخرى لإضافة المنتجات إلى سلة Buyee.'), _defineProperty(_defineProperty(_translation17, StatusCode.UNAVAILABLE_PRODUCT_URL_PURCHASE_GUIDANCE, 'لا يمكن استخدام "Add to Buyee" لهذا الموقع. يرجى استخدام "الشراء باستخدام عنوان URL للمنتج الذي تريده" على موقع Buyee.'), StatusCode.ERR_DIGITAL_CONTENT, 'لا يمكن شراء المحتوى الرقمي من خارج اليابان.'))
  }
};
  ...
  return _createClass(Seller, [{
    ...
    value: function parse() {
      try {
        ...
        return element.includes('予約') ? 'pre-order' : 'regular';
      } catch (e) {
        return 'regular';
      }
    }
...
var Unavailable = exports.default = /*#__PURE__*/function (_BaseElement) {
  ...
  return _createClass(Unavailable, [{
    ...
    value: function isLottery() {
      ...
      return description.includes('くじ');
    }
  }]);
}(_baseElement.default);
...
var Messages = exports.Messages = /*#__PURE__*/function () {
  ...
  function Messages() {
    ...
    /*
        外部ファイルに吐き出した場合i18nextはXMLでファイルを取得する。
        このためExtension上（Safari）ではCross Origin制約にひっかかるため
        内部リソースとして他言語化を行う
       dev, en: English
      ja:  日本語
      chs: 簡体字
  ...
  /**
   * メッセージを取得する.
   * @param {string} key - ステータス
   * @return {string} ステータス、言語設定が一致したメッセージを返す
   *
   * @example
...
/** ステータス: 一ページに複数商品がある場合(例、コーディネートページ) */
